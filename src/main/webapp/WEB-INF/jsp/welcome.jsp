...
<body>
<div class="welcom" style="margin-top:10%;">
	<h1 style="text-align: center; font-size: 48px;">欢迎进入选课系统</h1>
	<p style="text-align: center; margin-left:20%;">————学习就是一个不断超越和被超越的过程</p>
</div>
...
<script>
  ...
  createSheep();
  var create=setInterval(createSheep,2000);
  //创建小羊
